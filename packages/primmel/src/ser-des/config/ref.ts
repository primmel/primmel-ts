...
export function parseRef(t: string[], i: number, stripWrapping: (s: string) => string, unwrapBlock: (s: string) => string): { ref: Ref; next: number } {
...
export function dumpRefs(refs: Ref[] | undefined, indent: string, escapeString: (s: string) => string): string {
